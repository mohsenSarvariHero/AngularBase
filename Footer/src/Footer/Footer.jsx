  ...
  return (
    ...
    >
      <div className="bg-white w-255 h-115 z-10 rounded-2xl border border-[#79899E] relative bottom-[-40px]">
        ...
        <p
          className="text-[17px] px-8 text-justify  text-[#334155] tracking-tight leading-7"style={{ wordSpacing: "-1px" }}
        >
        ...
        <div>
          ...
          <div className="flex items-center justify-center pt-10">
            <div className="text-[#334155] text-[12px] w-[300px]  ">
              ...
              <div className="flex flex-row justify-between pb-3">
                <p>آی‌دی تلگرام</p>
                <p dir="ltr">@ourtelegramhandle</p>
              </div>
              <div className="flex flex-row justify-between">
                <p>شماره واتسپ</p>
                <p dir="ltr">0912 345 6789</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="bg-[#EBF2FE] w-full h-[300px] absolute bottom-0 left-0 z-0 border-t-1 border-t-[#B5CDF3]">
        <div className="relative flex justify-center">
          <p className="absolute top-62 text-[13px]">کلیه‌ی حقوق مادی و معنوی این وبسایت متعلق به گروه لوگو میباشد.</p>
        </div>
      </div>
    </div>
  );
