    ...
    >
      <div className="bg-white w-255 h-115 z-10 rounded-2xl border border-[#79899E] relative bottom-[-40px]">
        ...
        <div>
          ...
          <p className="text-[#334155] text-[16px] flex justify-center pt-18 tracking-normal relative">
            راه های ارتباطی با ما
            <span className="absolute top-27 left-108 w-[170px] border-b-3  border-[#3B82F6]"></span>
          </p>
