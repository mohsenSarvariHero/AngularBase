...
//       <div className="bg-white w-250 h-100 z-10 rounded-2xl border border-gray-500">
//       <h1>Logo</h1>
...
export default function Footer() {
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center">
      <div className="bg-white w-[1250px] h-[100px] z-10 rounded-2xl border border-gray-500">
        <h1>Logo</h1>
        <p>
      ...
      <div className="bg-[#EBF2FE] w-full h-[300px] absolute bottom-[-20px] left-0 z-0">
        {/* این div اکنون 20px پایین‌تر قرار می‌گیرد */}
      </div>
    </div>
  );
}
