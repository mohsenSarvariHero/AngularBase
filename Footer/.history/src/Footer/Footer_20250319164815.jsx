...
export default function Footer() {
  return (
    <div dir="rtl" className="relative min-h-screen flex flex-col items-center justify-center">
      <div className="bg-white w-280 h-125 z-10 rounded-2xl border border-[#79899E] relative bottom-[75px]">
        <h1 className="text-[60px] font-[800] text-[#3B82F6] p-4 flex justify-center">LOGO</h1>
        <p className="text-[18px] px-8 text-justify min-h-[100%] text-[#334155] leading-loose" style={{ wordSpacing: '-1px' }}>
