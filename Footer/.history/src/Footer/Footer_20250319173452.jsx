  ...
  return (
    ...
    >
      <div className="bg-white w-255 h-115 z-10 rounded-2xl border border-[#79899E] relative bottom-[-40px]">
        ...
        <div>
          ...
          <div className="flex items-center justify-center pt-10">
            <div className="text-[#334155] text-[13px] w-[330px]  ">
      ...
      <div className="flex justify-center items-center h-full">
          <p className="text-center text-[#334155] text-[14px]">
            کلیه‌ی حقوق مادی و معنوی این وبسایت متعلق به گروه لوگو می‌باشد.
          </p>
        </div>
      </div>
    </div>
