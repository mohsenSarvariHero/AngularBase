  ...
  return (
    <div dir="rtl" className="relative min-h-screen flex flex-col items-center justify-center">
      <div className="bg-white w-255 h-115 z-10 rounded-2xl border border-[#79899E] relative bottom-[-40px]">
        <h1 className="text-[50px] font-[800] text-[#3B82F6] p-4 flex justify-center">LOGO</h1>
        <p className="text-[17px] px-8 text-justify  text-[#334155] tracking-tight" style={{ wordSpacing: '-1px' }}>
        ...
        <div>
          ...
          <p className="text-[#334155] text-[16px] flex justify-center pt-18 relative">
  راه های ارتباطی با ما
  <span className="absolute bottom-[-10px] left-[-10px] right-[-10px] border-b-4 border-[#3B82F6]"></span>
</p>
          <div>
            <div>
              <p>ایمیل</p>
