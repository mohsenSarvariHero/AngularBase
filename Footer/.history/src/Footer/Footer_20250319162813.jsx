...
export default function Footer() {
  return (
    <div dir="" className="relative min-h-screen flex flex-col items-center justify-center">
      <div className="bg-white w-260 h-115 z-10 rounded-2xl border border-[#79899E] absolute bottom-[75px]">
      <h1 className="text-[60px] font-[900] text-[#3B82F6]">LOGO</h1>
      <p className="text-[15px]">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ، و با استفاده از طراحان گرافیک است، چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است، و برای شرایط فعلی تکنولوژی موری توان امید داشت که تمام و دشواری موجود در ارائه راهکارها، و شرایط سخت تایپ به پایان رسد و زمان مورد نیاز شامل حروفچینی دستاوردهای اصلی، و جوابگوی سوالات پیوسته اهل دنیای موجود طراحی اساسا مورد استفاده قرار گیرد.</p>
      <div>
