  ...
  return (
    <div ref={modalref} onClick={closemodal} className="fixed inset-0 text-amber-50  backdrop-blur-xs flex justify-center items-center ">
      <div className="mt-10 flex flex-col gap-5 text-black">
        <div className="rounded-xl bg-pink-200 px-20 py-10 flex flex-col gap-5 items-center mx-4 border-solid border-black">
          <h1 className='text-[#1d2b3e] text-[40px] font-bold'>ورود</h1>
          <form className='flex flex-col'>
            <input type="email" placeholder="youremailaddress@gmail.com / 0912 345 6789"className='border p-5'  style="border-color: #B5CDF3;"  required />
