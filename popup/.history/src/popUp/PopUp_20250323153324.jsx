  ...
  return (
    ...
    >
      ...
      <div className="relative">
        <input
          type={showPassword ? 'text' : 'password'} // نوع ورودی بستگی به showPassword دارد
          id="password"
          required
        ...
        >
          {showPassword ? (
            <FaEyeSlash size={20} color="#334155" />
          ) : (
            <FaEye size={20} color="#334155" />
          )}
        </button>
      </div>
    </div>
              ...
              <button type="submit" className="bg-[#3B82F6] text-white w-[135px] h-[45px] cursor-pointer font-bold rounded-xl mt-10">تایید</button>
              <button type="submit" className="border border-[#3B82F6] bg-[#EBF2FE] text-[#3B82F6] w-[200px] h-[50px] cursor-pointer rounded-xl mt-5 font-bold text-[15px]">ورود با رمز یکبار مصرف</button>
              </div>
              <div className="flex flex-col justify-center items-center mt-7">
              <a className="text-[#334155] text-[14px] font-medium">   !حساب کاربری ندارم  </a>   
              <a className="text-[#3B82F6] text-[18px] font-extrabold mt-2 cursor-pointer">ثبت نام</a>
              </div>
