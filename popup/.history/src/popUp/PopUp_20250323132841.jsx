        ...
        <div className="rounded-xl bg-white flex flex-col gap-5 items-center mx-4 border-1 border-black w-[700px] h-[600px] mb-5">
          ...
          <form className="flex flex-col">
            ...
            <label htmlFor="password"
                className="absolute right-2 top-2 text-l font-semibold text-[#334155] bg-white px-1 mr-3">رمز عبور</label>
              <input type="password" placeholder="enter your email" required className="border border-[#B5CDF3] rounded-md px-5 py-4 w-[400px] placeholder:text-[12px] mt-4" />
            </div>
