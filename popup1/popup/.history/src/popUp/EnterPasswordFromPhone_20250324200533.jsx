...
function EnterPasswordFromPhone({ onclose }) {
...
<div className="flex flex-col items-center">
            ...
            <p className="mt-5 text-[13px]">
              .رمز عبور را به شماره {phone} ارسال کردیم
            </p>
            <a className="text-[#3B82F6] text-[12px] mt-5">تغییر شماره</a>
          </div>
          ...
          <div className="flex flex-col items-center ">
            <Link
              type="submit"
              className="bg-[#3B82F6] text-white w-[135px] h-[45px] cursor-pointer font-bold rounded-xl mt-10 flex justify-center items-center"
              to="/ChangePassword"
            >
              تایید
            </Link>
   ...
   <Link className="text-[#3B82F6] text-[18px] font-extrabold mt-2 cursor-pointer" to>
     ثبت نام
   </Link>
 </div>
        </div>
...
export default EnterPasswordFromPhone