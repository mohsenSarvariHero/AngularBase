...
function SignupWithEmail({ onclose }) {
    ...
    >
      <div className="mt-10 flex flex-col gap-5 text-black">
        ...
        >
          ...
          <div>
            <Link className="text-[#3B82F6] text-[12px]" to="/SignupWithPhone">
          ...
          <div className="flex flex-col justify-center items-center mt-7">
            ...
            <Link className="text-[#3B82F6] text-[18px] font-extrabold mt-2 cursor-pointer"
            to="/Login">
              ورود
            </Link>
          </div>
