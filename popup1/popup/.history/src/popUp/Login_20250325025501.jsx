...
function Login({ onClose }) {
  ...
  // تابعی برای بستن پاپ‌آپ هنگام کلیک خارج از آن
  ...
  return (
    <div
      ref={modalRef}
      onClick={handleClickOutside} // زمانی که خارج از پاپ‌آپ کلیک شود، پاپ‌آپ بسته می‌شود
      className="fixed inset-0 flex justify-center items-center bg-black bg-opacity-50"
    >
      <div
        className="bg-white p-8 rounded-xl w-[400px]"
        onClick={(e) => e.stopPropagation()} // جلوگیری از بسته شدن پاپ‌آپ در هنگام کلیک روی خود پاپ‌آپ
      >
        <h1 className="text-[#1d2b3e] text-[35px] font-bold mb-6">
          ورود
        </h1>
        ...
        <form className="flex flex-col">
          ...
          <div className="relative flex flex-col mt-5">
            ...
            <input
              ...
              id="emailOrPhone"
              placeholder="youremailaddress@gmail.com / 0912 345 6789"
              className="border border-[#B5CDF3] rounded-md px-5 py-4 w-full mt-6 focus:outline-none"
              required
            />
          </div>
          ...
          <div className="relative flex flex-col mt-5">
            ...
            <div className="relative">
              <input
                ...
                id="password"
                required
                className="border border-[#B5CDF3] rounded-md pl-15 px-5 py-4 w-full mt-2 focus:outline-none"
              />
              <button
                type="button"
                onClick={togglePasswordVisibility}
