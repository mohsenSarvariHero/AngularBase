...
function Login({ onclose }) {
  ...
  // تابع برای بستن پاپ‌آپ زمانی که کلیک روی فضای بیرونی پاپ‌آپ باشد
  const closemodal = (e) => {
    if (modalref.current && !modalref.current.contains(e.target)) {
      setShowModal(false);
      setTimeout(() => {
        onclose(); // اجرای تابع onclose از والد
      }, 500);
    }
  };
  ...
  // برای نمایش پاپ‌آپ بعد از اولین بار لود شدن
  useEffect(() => {
    setShowModal(true);
  ...
  return (
    <div
      onClick={closemodal} // اگر روی فضای بیرونی پاپ‌آپ کلیک شود، پاپ‌آپ بسته می‌شود
    ...
    >
      <div className="mt-10 flex flex-col gap-5 text-black">
        <div
          ref={modalref} // مرجع به پاپ‌آپ که جلوی بسته شدن آن هنگام کلیک داخلش را می‌گیرد
          ...
          onClick={(e) => e.stopPropagation()} // جلوگیری از بسته شدن پاپ‌آپ وقتی که داخل پاپ‌آپ کلیک می‌شود
        >
          <h1
