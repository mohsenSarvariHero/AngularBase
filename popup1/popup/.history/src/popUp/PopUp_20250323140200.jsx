        ...
        <div className="rounded-xl bg-white flex flex-col gap-5 items-center mx-4 border-1 border-black w-[700px] h-[600px] mb-5">
          ...
          <form className="flex flex-col">
            ...
            {/* <div className="flex flex-col justify-center"> */}
              <a className="text-[#3B82F6] flex justify-ce00nter mt-4 text-[11px] font-normal cursor-pointer">فراموشی رمز عبور</a>
              <button type="submit"className="bg-[#3B82F6] ">تایید</button>
