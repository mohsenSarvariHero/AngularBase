...
function PopUp({onclose }) {
  ...
  return (
    <div ref={modalref} onClick={closemodal} className="fixed inset-0 text-amber-50  backdrop-blur-xs flex justify-center items-center ">
      <div className="mt-10 flex flex-col gap-5 text-black border-solid border-black">
        <div className="rounded-xl bg-white px-20 py-10 flex flex-col gap-5 items-center mx-4 border-solid border-black">
