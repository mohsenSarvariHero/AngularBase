...
function PopUp({onclose }) {
  ...
  {/* برچسب و ورودی ایمیل/شماره موبایل */}
  <label htmlFor="emailOrPhone" className="text-lg font-semibold text-gray-700">
    ایمیل / شماره موبایل
  </label>
  <input
    type="email"
    ...
    className="border border-[#B5CDF3] rounded-md px-5 py-4 w-[400px] placeholder:text-[12px] focus:outline-none focus:ring-2 focus:ring-[#B5CDF3] transition-all"
    required
  />
</div>
