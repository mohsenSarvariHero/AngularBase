...
import React, { useRef, useState, useEffect } from "react";
import { useNavigate } from "react-router-dom"; // وارد کردن useNavigate برای مسیریابی
...
function ForgetPassword({ onclose }) {
  ...
  const handleSubmit = (e) => {
    ...
    // اگر ورودی ایمیل باشد، به صفحه مربوطه هدایت می‌شود
    if (isEmail) {
      navigate("/EnterPasswordFromEmail"); // هدایت به صفحه ایمیل
    } else {
      navigate("/EnterPasswordFromPhone"); // هدایت به صفحه شماره موبایل
    }
  };
