        ...
        <div className="rounded-xl bg-white flex flex-col gap-5 items-center mx-4 border-1 border-black w-[700px] h-[600px] mb-5">
          ...
          <form className="flex flex-col">
            ...
            {/* <div className="flex flex-col justify-center"> */}
              ...
              <button type="submit" className="border border-[#3B82F6] bg-[#EBF2FE] text-[#3B82F6] w-[200px] h-[50px] rounded-xl mt-5v font-bold text-[15px">ورود با رمز یکبار مصرف</button>
              </div>
