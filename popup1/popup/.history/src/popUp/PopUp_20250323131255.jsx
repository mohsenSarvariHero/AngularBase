      ...
      <div className="mt-10 flex flex-col gap-5 text-black">
        <div className="rounded-xl bg-white flex flex-col gap-5 items-center mx-4 border-1 border-black w-[700px] h-[600px] mb-5">
          ...
          <form className='flex flex-col'>
            <input type="email" placeholder="youremailaddress@gmail.com / 0912 345 6789" className='border-1 border-[#B5CDF3] rounded-md px-5 py-4 w-[400px]  mt-10 placeholder:text-[15px]'    required />
