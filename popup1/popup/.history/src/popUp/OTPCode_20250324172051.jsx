...
//             <a className="text-[12px] text-[#3B82F6]  mr-5">ارسال دوباره کد</a>
//             <p>تایمر</p>
//           </div>
...
//             <button
//               type="submit"
//               className="border border-[#3B82F6] bg-[#EBF2FE] text-[#3B82F6] w-[160px] h-[40px] cursor-pointer rounded-xl mt-5 font-bold text-[15px]"
//             >
//               ورود با رمز عبور
//             </button>
//           </div>
    ...
    >
      <div className="mt-10 flex flex-col gap-5 text-black">
        <div className="rounded-xl bg-white flex flex-col gap-5 items-center mx-4 shadow-2xl w-[700px] h-[600px] mb-5 transition-all duration-500 transform ">
          ...
          <div className="w-[250px] flex flex-row items-end">
            <Link className="text-[12px] text-[#3B82F6] mr-5">ارسال دوباره کد</Link>
            <p>{seconds} ثانیه</p> {/* تایمر شمارش معکوس */}
          </div>
          <div className="flex flex-col items-center mt-3">
            <button
              type="submit"
