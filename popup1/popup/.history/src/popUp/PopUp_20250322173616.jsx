...
function PopUp({onclose }) {
  ...
  return (
    <div ref={modalref} onClick={closemodal} className="fixed inset-0 bg-black text-amber-50 opacity-30 backdrop-blur-sm flex justify-center items-center">
      <div className="mt-10 flex flex-col gap-5 text-red-700">
        <div className="rounded-xl bg-white px-20 py-10 flex flex-col gap-5 items-center mx-4">
          ...
          <form>
            ...
            <input type="email" placeholder="enter your email" required />
            <input type="pa" placeholder="enter your email" required />
