...
function Login({ onclose }) {
  ...
  // تابعی برای بستن پاپ‌آپ زمانی که کلیک در بیرون از پاپ‌آپ انجام می‌شود
  const closemodal = (e) => {
  ...
  return (
    <div
      onClick={closemodal}  // اینجا رو تغییر دادیم تا هرجا بیرون پاپ آپ کلیک کردیم بسته بشه
    ...
    >
      <div
        ref={modalref}  // اینجا پاپ‌آپ خودشه که به کلیک‌های داخل خودش رسیدگی می‌کنه
        className={`mt-10 flex flex-col gap-5 text-black`}
      >
        <div
